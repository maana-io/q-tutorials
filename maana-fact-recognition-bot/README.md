...
```graphql
mutation {
    addPattern(input : {predicateLemmas : ["buy"], subject : ["ANY"], object : ["ANY"]})
}
```
...
```graphql
mutation {
   extractByPattern(patternKindId : "2925878d-fd88-4b8e-a9d0-8f1f3c3d9a29", kindId : "7727dbf6-c931-458e-9e32-3fc80211f94e", fieldName : "Text")
}
```
...
```graphql
mutation a {
extractByExample(kindId: "bbcb2d1f-1c0c-4d81-adff-39de27d8fc52", fieldName : "Text", mapping : [{name : "name", value : "Carl"},{name : "object", value : "fish"},{name : "price", value : "5 dollars"},{ name : "location", value : "store"}], example : "Carl bought a fish for 5 dollars at the store", storageKindId : "e81846a4-ca93-4947-b8f2-57fb92ecb957")
}
```
...
```
create an instance of the "exampleContainer" with the following values
```json
{ example: "Carl bought a fish for 5 dollars at the store.", mapping : '{"name" : "Carl", "object" : "fish", "price" : "5 dollars", "location" : "store"}', required : ["name","object"], kindId : "e81846a4-ca93-4947-b8f2-57fb92ecb957"}
```
is created with the mutation below, where kindId is the id of the purchaseEvent kind.
```graphql
mutation e {
