namespace netBox.Types
{
    ...
    public class OpportunityObject : ObjectGraphType<Opportunity>
    {
        public OpportunityObject(IWellRepository wellRepository)
        {
            ...
            this.Field(x => x.actions, type: typeof(NonNullGraphType<ListGraphType<NonNullGraphType<DateTimeGraphType>>>));
